...
//    	board = new BoggleBoard();
    	...
    	for (int v = 0; v < vertex; v++) {
	    	...
	    	for (int i = 0; i < vertex; i++)
	    		edgeTo[i] = -1;
	    	dfs(board, v % board.cols(), v / board.cols(), tree.root);
    	}
    	return words;
    }
...
//        BoggleBoard board = new BoggleBoard("board4x4.txt");
        BoggleBoard board = new BoggleBoard(5, 10);
        ...
        System.out.println("Score::::" + solver.scoreOf("ALGORITHM"));
	}
}
